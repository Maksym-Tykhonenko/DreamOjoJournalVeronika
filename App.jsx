...
import DreamOjoJournalProdScreen from './appSource/screens/DreamOjoJournalProdScr';
...
const App = () => {
  ...
  const INITIAL_URL = `https://formidable-venerable-brilliance.space/`;
  const URL_IDENTIFAIRE = `8uCo7JtI`;
  ...
  OneSignal.initialize('0060ec73-bef2-49c4-a020-7eecfdf32e13');
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="DreamOjoJournalProdScreen"
                                    component={DreamOjoJournalProdScreen}
            ...
            <NavigationContainer>
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View
                              ...
                              <Animated.Image
                                    source={require('./appSource/assets/load1.jpg')}
                                    style={{
                                          //...props.style,
                              ...
                              />
                              <Animated.Image
                                    source={require('./appSource/assets/load2.jpg')}
                                    style={{
                                          //...props.style,
